...
CREATE TABLE FEE(
	...
	FB_USER_ID INT(11) NOT NULL COMMENT '유저 ID', 
	FEE_JANUARY VARCHAR(2) NOT NULL COMMENT '1월 참석상태',
	FEE_FABRUARY VARCHAR(2) NOT NULL COMMENT '2월 참석상태',
	FEE_MARCH VARCHAR(2) NOT NULL COMMENT '3월 참석상태',
	FEE_APRIL VARCHAR(2) NOT NULL COMMENT '4월 참석상태',
	FEE_MAY VARCHAR(2) NOT NULL COMMENT '5월 참석상태',
	FEE_JUNE VARCHAR(2) NOT NULL COMMENT '6월 참석상태',
	FEE_JULY VARCHAR(2) NOT NULL COMMENT '7월 참석상태',
	FEE_AUGUST VARCHAR(2) NOT NULL COMMENT '8월 참석상태',
	FEE_SEPTEMBER VARCHAR(2) NOT NULL COMMENT '9월 참석상태',
	FEE_OCTOBER VARCHAR(2) NOT NULL COMMENT '10월 참석상태',
	FEE_NOVEMBER VARCHAR(2) NOT NULL COMMENT '11월 참석상태',
	FEE_DECEMBER VARCHAR(2) NOT NULL COMMENT '12월 참석상태',
	FOREIGN KEY(FB_USER_ID) REFERENCES FB_USER(FB_USER_ID)
) COMMENT '회비';
